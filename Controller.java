...
public class Controller implements ButtonListener
{
   ...
   private MorseCoder morse = new MorseCoder();
   ...
   public void flashMorseLetter(String letter)
   {
       String code = morse.getCode(letter);
   ...
   public void flashMorseWord(String word)
   {
       for(char ch : word.toCharArray()) {
           flashMorseLetter(Character.toString(ch));
       }
   }
}
